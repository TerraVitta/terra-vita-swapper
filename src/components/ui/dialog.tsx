  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "glass rounded-2lg shadow-glass-lg",
...
const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div 
    className={cn(
      ...
      "pt-6 border-t border-glass-border",
      className
    )} 
    {...props} 
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ...
    className={cn(
      ...
      "bg-gradient-to-r from-verdigris via-emerald to-light-green bg-clip-text text-transparent",
      className
    )}
    {...props}
  />
